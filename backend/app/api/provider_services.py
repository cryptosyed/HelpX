...
from app.models import ProviderService, GlobalService
...
def list_provider_services(db: Session = Depends(get_db), current_provider=Depends(get_current_provider)):
